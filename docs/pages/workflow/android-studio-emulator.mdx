...
- On macOS, you will also need to add `platform-tools` to your `~/.bash_profile` (or `~/.zshenv` if you use Zsh) - eg. `export PATH=/your/path/here/platform-tools:\$PATH`. Copy and paste this line to do this automatically for Bash and Zsh:
